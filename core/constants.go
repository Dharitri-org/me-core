...
const MetricNumProcessedTxsTPSBenchmark = "moa_num_transactions_processed_tps_benchmark"
...
// DharitriAPICost represents the field name of the Dharitri SC API (EEI) gas costs
const DharitriAPICost = "DharitriAPICost"
...
const (
	...
	//MetricDctEnableEpoch represents the epoch when DCT is enabled
	MetricDctEnableEpoch = "moa_dct_enable_epoch"
...
const MetricP2PFullHistoryObservers = "moa_p2p_full_history_observers"
